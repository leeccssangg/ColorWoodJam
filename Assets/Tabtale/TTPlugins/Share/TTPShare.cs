...
#if UNITY_ANDROID && TTP_ANDROID_STORE_AMAZON
            Debug.Log(TTPLogger.LOGLabel + "TTPShare::ShareScreenshot: Amazon STUB");
            return;
#endif
...
#if UNITY_ANDROID && TTP_ANDROID_STORE_AMAZON
            Debug.Log(TTPLogger.LOGLabel + "TTPShare::ShareVideo: Amazon STUB");
            return;
#endif
...
#if UNITY_ANDROID && TTP_ANDROID_STORE_AMAZON
            Debug.Log(TTPLogger.LOGLabel + "TTPShare::ShareImage: Amazon STUB");
            return;
#endif
...
#if UNITY_ANDROID && TTP_ANDROID_STORE_AMAZON
            Debug.Log(TTPLogger.LOGLabel + "TTPShare::ShareLink: Amazon STUB");
            return;
#endif
...
#if UNITY_ANDROID && TTP_ANDROID_STORE_AMAZON
            Debug.Log(TTPLogger.LOGLabel + "TTPShare::ShareAppLink: Amazon STUB");
            return;
#endif
            String link = null;
#if UNITY_ANDROID
...
#if UNITY_ANDROID && TTP_ANDROID_STORE_AMAZON
            Debug.Log(TTPLogger.LOGLabel + "TTPShare::ShareImageBytes: Amazon STUB");
            yield return dst;
#else
            yield return dst;
