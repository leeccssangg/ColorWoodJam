...
namespace Tabtale.TTPlugins
{
    ...
    public class TTPGameProgression
    {
        ...
        {
            TTPLogger.Log("TTPGameProgression::MiniLevelStarted");

            DDNAEvents.MiniLevelStarted(miniMissionID, additionalParams);
        }
            
        public static void MiniLevelCompleted()
        {
            TTPLogger.Log("TTPGameProgression::MiniLevelCompleted");

            DDNAEvents.MiniLevelCompleted();
        }

        public static void MiniLevelFailed()
        {
            TTPLogger.Log("TTPGameProgression::MiniLevelFailed");

            DDNAEvents.MiniLevelFailed();
        }
        ...
        public class DDNAEvents
        {
            ...
            /// <summary>
            /// Log mini level started event
            /// </summary>
            /// <param name="miniMissionId">Mini level mission id</param>
            /// <param name="additionalParams">Other additional parameters</param>
            public static void MiniLevelStarted(int miniMissionID, Dictionary<string, object> additionalParams)
            {
            ...
            /// <summary>
            /// Log mini level completed event
            /// </summary>
            public static void MiniLevelCompleted()
            {
