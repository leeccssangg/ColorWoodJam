...
namespace Tabtale.TTPlugins
{
    ...
    public class TTPAnalytics
    {
        ...
        /// <summary> (Firebase) Called when remote config fetch is completed, with the remote config JSON.
        public static event System.Action<string> OnRemoteConfigReadyEvent;
        ...
        public static void LogEvent(long targets, string eventName, IDictionary<string, object> eventParams, bool timed, bool ttpInternal = false)
        {
            ...
            {
                Debug.LogWarning("TTPAnalytics::LogEvent: eventName is ad_impression. This is a reserved event name and should not be used. It will not be sent.");
                return;
            }
            if (Impl != null)
        ...
        class AnalyticsDelegate : MonoBehaviour
        {
            ...
            public void RemoteConfigReady(string remoteConfig) {
                 Debug.Log("TTPAnalytics::AnalyticsDelegate::RemoteConfigReady: " + remoteConfig);
                 if (remoteConfig != null && OnRemoteConfigReadyEvent != null)
                 {
                     OnRemoteConfigReadyEvent.Invoke(remoteConfig);
                 }
            }
