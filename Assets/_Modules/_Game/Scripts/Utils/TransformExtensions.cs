...
namespace Mimi.Prototypes
{
    ...
    public static class TransformExtensions
    {
        ...
        {
            transform.SetLocalPosition(transform.localPosition.x + x, transform.localPosition.y + y,
        ...
        {
            transform.SetEulerAngles(transform.eulerAngles.x + x, transform.eulerAngles.y + y,
        ...
        {
            transform.SetLocalEulerAngles(transform.localEulerAngles.x + x, transform.localEulerAngles.y + y,
